...
const Footer = () => {
  return (
    <footer className="bg-gray-100 text-gray-800 pt-16 pb-8 px-4 sm:px-6 border-t border-gray-200">
      <div className="container mx-auto max-w-7xl">
        <div className="w-full flex flex-col md:flex-row flex-wrap gap-8 md:gap-12 lg:gap-16 max-sm:flex">
          <motion.div
