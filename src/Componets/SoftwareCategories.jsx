...
// import applicationSoftware from "../assets/images/applicationSoftware.jpg";
...
//   //       <h2 className="text-4xl font-bold text-center mb-10 tracking-wide uppercase">
//   //         Software Categories
//   //       </h2>
...
//   //               viewport={{ once: true }}
//   //               className="bg-gray-800 p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-transform transform hover:-translate-y-2 cursor-pointer border border-gray-700 hover:border-indigo-400"
//   //             >
//   //               <img
//   //                 src={category.image}
//   //                 alt={category.title}
...
//   //           className="px-6 py-3 bg-indigo-600 hover:bg-indigo-500 transition duration-300 text-white font-semibold rounded-lg shadow-md hover:shadow-lg"
//   //         >
...
//   return (
//     <div className="bg-gray-900 text-white py-16 px-6 md:px-20">
//       <h2 className="text-4xl font-bold text-center mb-10 tracking-wide uppercase text-gradient bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 bg-clip-text text-transparent">
//         Explore Different Software Types
//       </h2>
//       <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
//         {softwareCategories
//           .slice(0, more ? softwareCategories.length : 3)
...
//                 className="w-full h-40 object-cover rounded-xl mb-4"
//               />
//               <h3 className="text-xl font-semibold mb-3 text-gradient bg-gradient-to-r from-blue-400 to-green-400 bg-clip-text text-transparent">
//                 {category.title}
//               </h3>
//               <p className="text-gray-300 mb-3 leading-relaxed">
//                 {category.description}
//               </p>
//               <div className=" px-4 py-2 rounded-lg shadow-xl bg-gradient-to-r from-pink-500 to-purple-500 font-bold text-center">Learn More</div>
//             </motion.div>
//           ))}
//       </div>
//       <div className="text-center mt-8">
//         <button
//           onClick={handleCategory}
//           className="px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-500 hover:from-indigo-500 hover:to-purple-400 transition duration-300 text-white font-semibold rounded-lg shadow-md hover:shadow-lg"
//         >
//           {more ? "View Less" : "View More"}
//         </button>
//       </div>
