...
//   return (
//     <div className="bg-gradient-to-r from-purple-900 to-blue-900 py-16 px-4 sm:px-6 lg:px-8">
...
//                   whileTap={{ scale: 0.97 }}
//                   className="flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all"
//                 >
...
//                   whileHover={{ scale: 1.03 }}
//                   whileTap={{ scale: 0.97 }}
//                   className="flex items-center justify-center px-6 py-3 border border-purple-600 text-purple-600 font-medium rounded-lg hover:bg-purple-50 transition-colors"
//                 >
//                   Email Us
//                 </motion.a>
//               </div>
//             </div>
//             <div className="hidden md:block md:w-1/3 bg-gradient-to-br from-purple-500 to-blue-500">
//               <div className="">
//                 <img src={support} alt="" className="w-full h-full" />
//               </div>
//             </div>
//           </div>
//         </motion.div>
