...
//             whileHover={{ y: -5 }}
//             className={`${item.color} p-4  rounded-xl shadow-lg w-full sm:w-64 text-white`}
//           >
//             <div className="flex items-center mb-4">
//               <div className="p-3 bg-white text-black bg-opacity-20 rounded-full mr-4">
//                 {item.icon}
//               </div>
...
//       {/* Main Content */}
//       <div className="flex flex-col lg:flex-row w-full bg-gray-900 px-6 pb-16">
//         {/* Map Section */}
//         <motion.div
//           initial={{ opacity: 0, x: -50 }}
//           animate={{ opacity: 1, x: 0 }}
//           transition={{ duration: 0.6 }}
//           className="w-full lg:w-1/2 h-96 lg:h-[500px] rounded-xl overflow-hidden shadow-2xl mb-6 lg:mb-0 lg:mr-6"
//         >
//           <iframe
//             src={mapLocation}
//             width="100%"
...
//         >
//           <div className="w-full max-w-lg p-4 bg-gray-800 rounded-xl shadow-2xl border border-gray-700">
//             <div className="text-center mb-4">
//               <h2 className="text-4xl font-bold mb-2 bg-gradient-to-r from-pink-400 to-purple-600 bg-clip-text text-transparent">
//                 Get In Touch
//               </h2>
...
//                     <label
//                       htmlFor={entry}
//                       className="block text-sm font-medium capitalize text-purple-400 mb-1"
//                     >
//                       {entry}
//                     </label>
//                     {entry === "message" ? (
...
//                         className="w-full px-4 py-3 mt-1 bg-gray-700 border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 text-white placeholder-gray-400 transition duration-300"
//                         rows="5"
...
//                   whileTap={{ scale: 0.98 }}
//                   type="submit"
//                   className="w-full py-3 px-6 bg-gradient-to-r from-pink-500 to-purple-600 rounded-lg hover:from-pink-600 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-400 text-white font-semibold shadow-lg transition duration-300 ease-in-out transform"
//                 >
//                   Send Message
//                 </motion.button>
//               </form>
